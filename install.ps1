...
Write-Host "  ${green}.\prometheus init${reset}        Initialize a new repository"
Write-Host "  ${green}.\prometheus pull${reset}        Pull latest updates"
Write-Host "  ${green}.\prometheus sync${reset}        Pull and push changes"
Write-Host "  ${green}.\prometheus help${reset}        Show all commands"
Write-Host ""
Write-Host "Note: Use the ${green}.\prometheus${reset} wrapper script for easy command execution"
Write-Host "      (it automatically activates the virtual environment)"
Write-Host ""
